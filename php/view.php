...
<table id="userInfo" width="60%" style="margin-top:50px;"  cellspacing="10" cellpadding="5" align="left">
  	<tr id="tableHead">
      <th colspan="2" width="100%" align="center"><strong>PRODUCT DETAILS:</strong></th>
  ...
  <tr>
      <td width="30%" id="heads"><strong>Product-Rating:</strong></td>
      <td width="70%" id="detail">
       <?php echo $imgrate; ?></td>
    </tr>
